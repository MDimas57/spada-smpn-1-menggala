...
class JawabanKuis extends Model
{
    ...
    /**
     * Accessor: ambil Guru pengampu dari jawaban ini melalui relasi kuis -> modul -> guru
     * Berguna sebagai helper read-only: gunakan eager-load `kuis.modul.guru` untuk menghindari N+1
     */
    public function getGuruAttribute()
    {
        return $this->kuis?->modul?->guru;
    }
}
